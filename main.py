...
# 객체 생성
load_dotenv()
access = "aig9UcKmxI5JoCixExxwtR3HxSjIhchmQUN0aSAw"
secret = "UpQQy1uBxBSQ2TYBsScGvUf0nC0lHDVZU3aFlwEl"
upbit = pyupbit.Upbit(access, secret)
token = "5069044402:AAGo22vmp7TFh1eY76dxxZyLiAFK0zQFSRs"
...
# 변수 설정
coin_list = ["KRW-BTC","KRW-DOGE"]
n = len(coin_list)
percent_list = [0.40]*n # 가진 돈의 5프로씩만 투자함
INF = 1000000000000
skip_list = []
n = len(coin_list)
money_list = [0]*(n)
